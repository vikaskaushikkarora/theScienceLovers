...
ax.text(2.7,0.8,'But if one of them is bigger , the \ncentre of mass lies near the heavier \none . Now the bigger mass takes the \nsmaller circle .',size=21 , color='lightcyan')

ax.text(1.25,0.9,'Centre of \n   mass .',size=10 , color='lightcyan')
...
line1,= ax.plot([], [],'o',color='lightskyblue',markersize=20)
