...
ax.text(0.3,1.65,'When object has the speed more than required \nto go in circular orbits , but less than escape speed',color='seagreen',size=20)

ax.text(0.6,1.25,r'$v>\sqrt{\frac{GM}{R}}$',color='lightcoral',size=20)
ax.text(0.6,1,r'$v<\sqrt{\frac{2GM}{R}}$',color='lightcoral',size=20)
