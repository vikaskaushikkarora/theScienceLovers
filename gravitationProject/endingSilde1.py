...
ax.text(1.4,1.5,"That's all for now !",color='lightskyblue',size=40)

ax.text(4.5,0.12,"The Science Lovers",color='white',size=15)

ax.text(1,1,'An animation by :',color='white',size=25)

ax.text(3,0.7,'Vikas Kaushik Sharma',color='seagreen',size=25)
