...
ax.text(2.8,0.25,'Earth',color='white',size=25)
def ell (a,b,c,d):
...
ax.text(3.5,1.5,'Ball thrown with speed \nless than what is required \nto go into circular orbit',color='seagreen',size=20)


t=np.arange(0,3.55,0.001)
h=t[1]-t[0]
T=len(t)
...
def animate(i):
	line.set_data(3+x[10*i],-10+y[10*i])
	line1.set_data(3+x[0:10*i],-10+y[0:10*i])
