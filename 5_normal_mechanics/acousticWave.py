...
ax.text(-29,1.05,'This is how a sound wave \ntravels through Air .',color='seagreen',size=28)

ax.text(-35,-1.33,'It seems like the particles are moving ahead , \nbut in fact only disturbance moves .',color='lightyellow',size=20)
