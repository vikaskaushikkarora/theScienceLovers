# Visualling Quantum Wave Function ( Particle in a box ) ________________________________
#Libraries
import numpy as np
import cmath
...
for i in range (int(T*s**(-1))):
	...
	ax.plot(x,psi[s*i,:].real,psi[s*i,:].imag,color='deepskyblue')
