# Visualling Quantum Wave Function ( Harmonic - Potential ) ________________________________
#Libraries
import numpy as np
import cmath
...
for i in range (int(T*s**(-1))):
	...
	ax.set_zticks([])
	ax.set_axis_off()
	ax.view_init(elev=20 , azim=80+0.002*s*i)
	...
	#Plotting Potential
	ax.plot(x,[0]*m,0.00003*V,color='coral',label='Potential')
	ax.legend()
